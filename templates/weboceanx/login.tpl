{* login.tpl *}
<style>
    .auth-card { display: flex; min-height: 80vh; background: #1e293b; border-radius: 24px; box-shadow: 0 20px 40px rgba(0,0,0,0.3); overflow: hidden; margin-top: 2rem; margin-bottom: 2rem; }
    ...
    .form-control-lg { border-radius: 12px; border: 1px solid #334155; padding: 0.75rem 1.25rem; font-size: 1rem; background-color: #0f172a; color: #e2e8f0; }
    .form-control-lg:focus { border-color: #4ade80; box-shadow: 0 0 0 3px rgba(74, 222, 128, 0.1); background-color: #0f172a; color: #e2e8f0; }
...
<div class="auth-card">
    <div class="auth-left">
        <div class="mb-5">
            <a href="{$WEB_ROOT}/index.php" class="text-decoration-none text-white fw-bold fs-3 d-flex align-items-center gap-2">
                <i class="bi bi-cloud-fill" style="color: #4ade80;"></i> WebOceanX
            </a>
        </div>
        <h1 class="display-5 fw-bold mb-4 text-white">Login</h1>
        ...
        <form method="post" action="{$systemurl}dologin.php" role="form">
            ...
            <div class="mb-4">
                <label class="form-label fw-bold text-white small">Username <span class="text-danger">*</span></label>
                <input type="email" name="username" class="form-control form-control-lg" placeholder="Email address" required autofocus>
            </div>
            <div class="mb-4">
                <label class="form-label fw-bold text-white small">Password <span class="text-danger">*</span></label>
                <div class="input-group">
                    <input type="password" name="password" class="form-control form-control-lg border-end-0" placeholder="Password" required>
                    <span class="input-group-text bg-dark border-secondary border-start-0 text-muted" style="border-radius: 0 12px 12px 0;"><i class="bi bi-eye-slash"></i></span>
                </div>
            </div>
            ...
            <div class="text-center text-muted small">
                New to WebOceanX? <a href="register.php" class="text-white fw-bold text-decoration-underline">Create an account</a> to get started<br><br>
                <a href="pwreset.php" class="text-white fw-bold text-decoration-underline">Forgot password?</a>
            </div>
        </form>
    </div>
